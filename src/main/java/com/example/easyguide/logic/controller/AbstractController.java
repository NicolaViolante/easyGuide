...
public abstract class AbstractController {
    protected void storeSessionUser(String username, String name, String surname, String email, Role role) throws SessionUserException{
        SessionManager sessionManager = SessionManager.getInstance();
        User currentUser = new User(username, name, surname, email, role);
